...
from src.multiomic_modeling.analyses_and_paper_figures_section.results_and_figures_analysis import best_config_file_path_normal_data_aug_2000, best_config_file_path_normal_normal_2000
...
class TurnOffViewsDatasetNormal(MultiomicDatasetNormal):
    ...
    def __init__(self, data_size: int = 2000, 
        ...
        self.dict_cancer_to_views = {0:['methyl','rna'], 
                                     1:['methyl', 'rna'], 
                                     2:['mirna', 'rna'],  
                                     3:['methyl', 'mirna','rna'], 
                                     4:['methyl', 'mirna','rna'], 
